    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <a href="./pets/"
                    class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[#f53003] dark:text-[#FF4433] ml-1">Домашни
                    любимци</a>
                <br><br>
                <h1 class="text-lg font-semibold mb-3">LAST 10 RECORDS</h1>
                <style>
                    table {
                        width: 100%;
                        border-collapse: collapse;
            ...
            <div
                class="relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/364] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">
                <br><br><br><br><br>
                <center>
                    <img src="{{ asset('images/logo.png') }}" alt="Logo" width="400">
                </center>
                <br><br>
                <div
